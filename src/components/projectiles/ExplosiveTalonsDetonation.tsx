...
export default function ExplosiveTalonsDetonation({
  ...
  return (
    <group ref={groupRef} position={[px, py, pz]}>
      <pointLight color={ACCENT} intensity={2.2} distance={EXPLOSIVE_TALONS_EXPLOSION_RADIUS * 3} decay={2} />
      <pointLight color={VENOM} intensity={1.4} distance={EXPLOSIVE_TALONS_EXPLOSION_RADIUS * 2.2} decay={2} />
