...
import BeastTemple, { BEAST_TEMPLE_HP_BAR_Y } from '@/components/environment/BeastTemple';
import type { Position3 } from '@/utils/position3';

interface BeastTempleRendererProps {
  id: string;
  position: Position3;
  rotation: number;
  health: number;
...
export default React.memo(BeastTempleRenderer);
