...
export function exploreTreeVariant(x: number, z: number): ExploreTreeVariant {
  return (hash2(0x7e31, Math.round(x * 4), Math.round(z * 4)) % 3) as ExploreTreeVariant;
}
