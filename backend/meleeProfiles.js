...
const MELEE_PROFILES = {
  ...
  'allied-siege-golem': buildProfile({
    type: 'allied-siege-golem',
    eventPrefix: 'allied-siege-golem',
    idField: 'siegeGolemId',
    weightClass: 'giant',
    range: 3.0,
    cooldownMs: 2250,
    swingLockMs: 1940,
    ...
    knockback: { distance: 7, duration: 0.5 },
    hitStopMs: 90,
    cooldownMapKey: 'siegeGolemAttackCooldown',
  }),
  'allied-siege-wyrm': buildProfile({
